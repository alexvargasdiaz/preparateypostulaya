...
import { GraduationCap, Mail, Lock, BookOpen, BarChart3, Gift, ArrowRight, Sparkles } from 'lucide-react';
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
                        ...
                        <div className="cyber-card rounded-2xl p-8">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <h2 className="text-2xl font-heading font-black text-text-primary">Bienvenido</h2>
                            </div>
                            <p className="mt-1 text-sm text-text-secondary">Ingresa tus credenciales para acceder</p>
                            ...
                            <form onSubmit={(e) => { e.preventDefault(); handleSubmit(e); }} className="mt-6 space-y-5">
                                <div>
                                ...
                                <div>
                                    <label className="block text-sm font-bold text-text-primary mb-1.5">Contraseña</label>
                                    <div className="relative cyber-input-wrapper">
                                ...
                                <div className="flex items-center">
                                    <label className="flex items-center gap-2 cursor-pointer">
                                        <Checkbox checked={remember} onCheckedChange={(val) => setRemember(val === true)} />
                                        <span className="text-sm font-semibold text-text-secondary">Recordarme</span>
                                    </label>
                                </div>
                            ...
                            <div className="relative my-6">
                                ...
                                <div className="relative flex justify-center"><span className="bg-surface px-4 text-xs font-bold uppercase text-text-muted">O continúa con</span></div>
                            </div>
                            ...
                            <p className="mt-6 text-center text-sm text-text-secondary">
                                ¿No tienes cuenta?{' '}
                                <Link href="/register" className="font-bold text-neon-cyan hover:underline neon-text-cyan">Regístrate aquí</Link>
                            </p>
                        </div>
                    </motion.div>
                </div>
